...
public class AudioService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    public static final String ACTION_PLAY = "com.example.meditation.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.example.meditation.ACTION_PAUSE";
    public static final String ACTION_PREVIOUS = "com.example.meditation.ACTION_PREVIOUS";
    public static final String ACTION_NEXT = "com.example.meditation.ACTION_NEXT";
    public static final String ACTION_STOP = "com.example.meditation.ACTION_STOP";

    public static final String CHANNEL_ID = "com.example.meditation.MEDITATION_APP";
    //MediaSession
    ...
    private void register_playNewAudio() {
        ...
        IntentFilter filter = new IntentFilter(RelaxFragment.Broadcast_PLAY_NEW_AUDIO);
